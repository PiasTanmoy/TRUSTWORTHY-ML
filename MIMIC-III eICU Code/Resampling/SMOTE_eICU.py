...
output_folder = 'data/task-data/in-hospital-mortality/eICU_dataset/train_0_filled_48H_SMOTE'
output_folder_labels = "data/task-data/in-hospital-mortality/eICU_dataset/"

# load any sample (but ideal shape sample) to reshape and add columns to the flattened samples
df = pd.read_csv(data_folder+"/141265_episode1_timeseries.csv")
...
# data/task-data/in-hospital-mortality/eICU_dataset/X_train_0_filled_48H_flattened_raw.npy
...
resampled_labels_file = os.path.join(output_folder_labels, s+'_SMOTE_labels.csv')
