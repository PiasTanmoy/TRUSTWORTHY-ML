...
def Select_Threshold_calibrated(df):
    ...
    for threshold in np.arange(0.01, 1.0, 0.01):
        ...
        full_threshold_list.append([threshold, f1_C1, balanced_accuracy]) # use minority class 1 (death) for LCS
...
test_dirs = ['Test2/CS_Tumor_Size/CS_Turmor_Size_valid_norm_range_0_42_seed_', #0_x.csv,
     'Test2/Num_lymph/num_lymph_valid_norm_range_0_10_seed_',
     'Test2/Pos_lymph/pos_lymph_valid_norm_range_0_25_seed_']

save_directory_path = "Test_results/XGBoost/"
...
best_params = {'colsample_bytree': 1.0, 'learning_rate': 0.1, 'max_depth': 5, 'n_estimators': 300, 'subsample': 0.8}
...
for test_path in test_dirs: 
    ...
    for i in range(3):
        ...
        file_path = os.path.join(save_directory_path, path.split("/")[1]+ ".csv")
