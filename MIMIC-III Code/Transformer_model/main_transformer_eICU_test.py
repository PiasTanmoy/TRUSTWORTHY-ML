...
#model_path = "Models/Transformer_2_eICU/Trial_3/checkpoints/model_epoch_36.keras" # eICU
model_path = "Models/Transformer_2_eICU/Trial_2/checkpoints/model_epoch_74.keras" # eICU
model_path = "Models/Transformer_2_eICU/Trial_1/checkpoints/model_epoch_85.keras" # eICU
...
for t in attributes:
    ...
    for i in range(1, 5+1):
        ...
        test_model2(model, 
                    ...
                    test_X, test_y, test_names,
                    opt_threshold=0.23,
                    out_dir=f"Models/Transformer_2_eICU/Trial_1/results/Test-2/{t}/",
                    epoch=f"_{i}")
...
#             val_X, val_y, val_names,
#             test_X, test_y, test_names,
#             out_dir="Models/Transformer_2_eICU/Trial_3/results/Original",
#             opt_threshold=None)
