...
save_dir = 'Oxygen set - Seed5 - SD 11/'
...
'''
def create_oxy_distribution(mu, sigma = 48, count = 53):
    a = max(mu-sigma/2, 0)
    b = mu+sigma/2
...
for i in range(start, end+1):
    ...
    values = create_oxy_distribution(mu=i, sigma=sigma, count=case.shape[0])
